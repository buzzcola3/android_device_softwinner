...
$(call inherit-product-if-exists, device/softwinner/cupid-perf1/tv_base.mk)
...
PRODUCT_NAME := cupid_perf1
PRODUCT_DEVICE := cupid-perf1
# PRODUCT_BOARD must equals the board name in kernel
PRODUCT_BOARD := perf1
PRODUCT_MODEL := QUAD-CORE H616 PERF1
